...
public class Summary extends javax.swing.JFrame {
    ...
    public Summary() {
        initComponents();
        jLabel1.setText(Renter.getFirstName()+" "+Rent.getRenter().getLastName());
        jLabel2.setText(Rent.getCar().getBrand());
        jLabel3.setText(Rent.getDuration()+" day ");
        jLabel4.setText(Rent.calculatePrice()+" SR");
